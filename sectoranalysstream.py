...
SECTOR_STOCKS = {
    ...
    "CNXINFRA": ["UNTRACEMCO", "TATAPOWER", "SIEMENS","SHREECEM", "RELIANCE", "POWERGRID","ONGC", "NTPC", "MOTHERSON","MAXHEALTH", "LT", "IOC","INDUSTOWER", "INDIGO", "INDHOTEL","HINDPETRO", "GRASIM", "GDREJPROP","GAIL","DLF","CUMMINSIND","CGPOWER","BPCL","BHARTIARTL", "BHARATFROGE","ASHOKLEY","APOLLOHOSP","AMBUJACEM", "ADANIPORTS","ADANIGREENS"]
