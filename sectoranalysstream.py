...
SECTOR_STOCKS = {
    ...
    "CNXINFRA": ["ULTRACEMCO", "TATAPOWER", "SIEMENS","SHREECEM", "RELIANCE", "POWERGRID","ONGC", "NTPC", "MOTHERSON","MAXHEALTH", "LT", "IOC","INDUSTOWER", "INDIGO", "INDHOTEL","HINDPETRO", "GRASIM", "GODREJPROP","GAIL","DLF","CUMMINSIND","CGPOWER","BPCL","BHARTIARTL", "BHARATFROGE","ASHOKLEY","APOLLOHOSP","AMBUJACEM", "ADANIPORTS","ADANIGREEN"]
